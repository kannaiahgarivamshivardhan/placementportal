                ...
                <div class="row">
                    ...
                    <div class="col-md-8  col-sm-1 col-xs-2 mt-n1 ml-4">
                        ...
                        <div class="col mt-2">
                            ...
                            if (empty($x)) {
                                echo $y . " Pre Offed by Africa Govt Students ";
                            } else {
                                echo $x . " Pre Offed by Africa Govt Students ";
                            }
                            echo "</div></center>";
                            ?>
                            ...
                            <table id="placementtable">
                                ...
                                if (empty($school)) {
                                    $sql = "SELECT * from placementstatus where year=$year and status='Pre Offed by Africa Govt' ";
                                }
                                elseif (empty($branch)) {

                                    $sql = "SELECT * from placementstatus where year=$year and school ='$school' and status='Pre Offed by Africa Govt' ";
                                } else {
                                    $sql = "SELECT * from placementstatus where year=$year and school ='$school' and branch='$branch'  and status='Pre Offed by Africa Govt' ";
                                }
