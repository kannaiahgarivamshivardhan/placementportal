                ...
                <div class="row">
                    ...
                    <div class="col-md-8  col-sm-1 col-xs-2 mt-n1 ml-4">
                        ...
                        <div class="col mt-2">
                            ...
                            if (empty($x)) {
                                echo $y . " Not Placed Students";
                            } else {
                                echo $x . " Not Placed Students";
                            }
                            echo "</div></center>";
                            ?>
                            <table id="placementtable">
                                ...
                                if (empty($school)) {
                                    $sql = "SELECT * from placementstatus where year=$year and status='Not Placed' ";
                                }
                                elseif (empty($branch)) {
                                    $sql = "SELECT * from placementstatus where year=$year and school ='$school' and status='Not Placed' ";
                                } else {
                                    $sql = "SELECT * from placementstatus where year=$year and school ='$school' and branch='$branch'  and status='Not Placed' ";
                                }
                                $result = $con->query($sql);
                                if ($result->num_rows > 0) {
                                    while ($row = $result->fetch_assoc()) {

                                        echo "<tr><td>" . $row['name'] . "</td><td>" . $row['rollno'] . "</td><td>" . $row['year'] . "</td><td>" . $row['branch'] . "</td><td>" . $row['email'] . "</td><td>" . $row['cgpa'] . "</td></tr>";
                                    }
                                }
