                ...
                <div class="row">
                    ...
                    <div class="col-md-8  col-sm-1 col-xs-2 mt-n1 ml-4">
                        ...
                        <div class="col mt-2">
                            ...
                            if (empty($x)) {
                                echo $y . " Placed Students";
                            } else {
                                echo $x . " Placed Students";
                            }
                            echo "</div></center>";
                            ?>
                            <table id="placementtable">
                                ...
                                <tr class="text-center">
                                    ...
                                    <th style="cursor: pointer;">Total Offers</th>
                                    <th style="cursor: pointer;">Super Dream</th>
                                    <th style="cursor: pointer;">Dream</th>
                                    <th style="cursor: pointer;">Regular</th>
                                    <th style="cursor: pointer;">Salary</th>
                                    <th style="cursor: pointer;">COM1</th>
                                    <th style="cursor: pointer;">COM2</th>
                                    <th style="cursor: pointer;">COM3</th>
                                    <th style="cursor: pointer;">COM4</th>
                                    <th style="cursor: pointer;">COM5</th>
                                    <th style="cursor: pointer;">COM6</th>
                                ...
                                //}
                                if (empty($school)) {
                                    $sql = "SELECT * from placementstatus where year=$year and status='Placed' ";
                                }
                                elseif (empty($branch)) {
                                    $sql = "SELECT * from placementstatus where year=$year and school ='$school' and status='Placed' ";
                                } else {
                                    $sql = "SELECT * from placementstatus where year=$year and school ='$school' and branch='$branch'  and status='Placed' ";
                                }
                                $result = $con->query($sql);
                                
                                    while ($row = $result->fetch_assoc()) {

                                        echo "<tr><td>" . $row['name'] . "</td><td>" . $row['rollno'] . "</td><td>" . $row['year'] . "</td><td>" . $row['branch'] . "</td><td>" . $row['email'] . "</td><td>" . $row['cgpa'] . "</td><td>" . $row['totaloffers'] . "</td><td>" . $row['superdream'] . "</td><td>" . $row['dream'] . "</td><td>" . $row['regular'] . "</td><td>" . $row['salary'] . "</td><td>" . $row['com1'] . "</td><td>" . $row['com2'] . "</td><td>" . $row['com3'] . "</td><td>" . $row['com4'] . "</td><td>" . $row['com5'] . "</td><td>" . $row['com6'] . "</td></tr>";
                                    }
