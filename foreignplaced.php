                    ...
                    <div class="col-md-8  col-sm-1 col-xs-2 mt-n1 ml-4">
                        ...
                        <div class="col mt-2">
                            ...
                            <table id="placementtable">
                                ...
                                if (empty($school)) {
                                    $sql = "SELECT * from placementstatus where year=$year and status='Foreign student  Placed' ";
                                }
                                elseif (empty($branch)) {

                                    $sql = "SELECT * from placementstatus where year=$year and school ='$school' and status='Foreign student  Placed' ";
                                } else {
                                    $sql = "SELECT * from placementstatus where year=$year and school ='$school' and branch='$branch'  and status='Foreign student  Placed' ";
                                }
